...
from sun4py.dmrg.dmrgbase import DMRGSolver
...
class DMRGSolverFund(DMRGSolver):
    ...
    def __init__(self, N, Ns, num_irreps, max_num_states, target, **kwargs):
        ...
        if 'rme_filename' in kwargs:
            ...
            user_dir = os.getcwd()
            rme_dir = os.path.join(user_dir, 'sun4py_rmes')
            self._rme_filename = ''
    ...
    def _idmrg_init(self):
        ...
        for q in range(0, i_TAB1):
            ...
            for bc in bcs:
                ...
                alpha_asc[bc] -= 1
                index_asc = sun4py.common.math.find_row(TAB0, alpha_asc)
    ...
    def _get_ascendants_indices(self, alpha, TAB1):
        ...
        for bc in bcs:
            ...
            ind_asc = sun4py.common.math.find_row(TAB1, alpha_asc)
            if len(ind_asc)>0:
    ...
    def _get_HLR(self, n, tensor_bool, ind_relevant_irreps):
        ...
        for q in range(0, num_relevant_irreps):
            ...
            ind_nu1 = sun4py.common.math.find_row(TAB[ind_relevant_irreps], nu1)
            assert(len(ind_nu1)==1)
            ind_nu1 = ind_nu1[0]
            assert(ind_nu1==q)
            
            ind_g_nu1 = sun4py.common.math.find_row(TAB, nu1)
            ...
            for p in range(0, len(nu1_friends_indices)):
                ...
                ind_nu2 = sun4py.common.math.find_row(TAB[ind_relevant_irreps], nu2)
                assert(len(ind_nu2)==1)
                ind_nu2 = ind_nu2[0]                
                ind_g_nu2 = sun4py.common.math.find_row(TAB, nu2)
                ...
                for k in range(0, length_bottom):
                    ...
                    ind_alpha_asc1 = sun4py.common.math.find_row(TAB1, alpha_asc1)
                    ind_alpha_asc2 = sun4py.common.math.find_row(TAB1, alpha_asc2)
                    ...
                    for qq in range(0, ndesc1):
                        ...
                        ind_nu3 = sun4py.common.math.find_row(TAB[ind_relevant_irreps], nu3)
                        ...
                        ind_g_nu3 = sun4py.common.math.find_row(TAB, nu3)
                        ...
                        ind_nu3_asc = sun4py.common.math.find_row(TAB1, nu3_asc)
                        ...
                        for pp in range(0, ndesc2):
                            ...
                            ind_nu4 = sun4py.common.math.find_row(TAB[ind_relevant_irreps], nu4)
                            ...
                            ind_g_nu4 = sun4py.common.math.find_row(TAB, nu4)
                            ...
                            ind_nu4_asc = sun4py.common.math.find_row(TAB1, nu4_asc)
